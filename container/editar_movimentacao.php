...
$sql_movimentacao = "SELECT * FROM movimentacao WHERE id = '$id'";
$query_movimentacao = $mysqli->query($sql_movimentacao) or die($mysqli->error);
$movimentacao = $query_movimentacao->fetch_assoc();
    ...
    <div style="padding:0 20% ;">
        <form action="" method="post">
            <div class="input-group mb-3">
                ...
                <input readonly style="text-transform: uppercase ;" value="<?php echo $movimentacao['container']; ?>" name="container" type="text" class="form-control" placeholder="TEST1234567" aria-label="Usuário" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <select name="movimentacao" class="custom-select" id="inputGroupSelect01">
                    <option value="<?php echo $movimentacao['movimentacao'] ?>"><?php echo $movimentacao['movimentacao'] ?></option>
            ...
            <div class="input-group mb-3">
                ...
                <input style="text-transform: uppercase ;" value="<?php echo $movimentacao['inicio']; ?>" name="inicio" type="datetime-local" class="form-control" placeholder="TEST1234567" aria-label="Usuário" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input style="text-transform: uppercase ;" value="<?php echo $movimentacao['fim']; ?>" name="fim" type="datetime-local" class="form-control" placeholder="TEST1234567" aria-label="Usuário" aria-describedby="basic-addon1">
            </div>
