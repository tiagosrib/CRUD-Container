...
if(isset($_POST['excluir'])) {
    ...
    $sql_code = " DELETE FROM senhas WHERE id = '$id'";
    $sql_query = $mysqli->query($sql_code) or die($mysqli->error);

    if($sql_query) {
        ?> 
        <h1>Excluido com Sucesso !! </h1>
        <p>Voltar para <a href="listar_usuarios.php">Lista de Usuários</a></p>
        <?php
        die();
    }
}
...
<head>
    ...
    <title>Exlcuir Acesso</title>
</head>
<body>
    <h1>Tem Certeza que deseja excluir o Acesso do Usuário ??</h1>
