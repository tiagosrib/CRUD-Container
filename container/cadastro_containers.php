...
if(count($_POST)>0) {
    ...
    if($erro){
        ...
        $sql_code = " INSERT INTO container (container, cliente, tipo, status, categoria)
        VALUES ('$container','$cliente','$tipo','$status','$categoria')";
        $cadastrado = $mysqli->query($sql_code) or die($mysqli->error);
        if($cadastrado){
            echo "Container Cadastrado com Sucesso!!";
            unset($_POST);
        }
    }
...
<body>
    ...
    <h1 style="text-align:center;">Cadastro de Containers</h1>
    <div style="padding:0 20% ;">
        <form action="" method="post">
            <div class="input-group mb-3">
                ...
                <input style="text-transform: uppercase ;" value="<?php if(isset($_POST['container'])) echo $_POST['container']; ?>" name="container" type="text" class="form-control" placeholder="TEST1234567" aria-label="Usuário" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input value="<?php if(isset($_POST['cliente'])) echo $_POST['cliente']; ?>" name="cliente" type="text" class="form-control" placeholder="Identificação do Cliente" aria-label="Usuário" aria-describedby="basic-addon1">
            </div>
            ...
            <button type="submit" class="btn btn-primary">Cadastrar Container</button>
        </form>
    </div>
